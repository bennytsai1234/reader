...
- `TTSService`（`core/services/tts_service.dart`）— 全域單例，在 `main()` 初始化
...
- `core/services/backup_service.dart` — 本地 ZIP 備份
...
- 設計文檔在 `docs/`：`architecture.md`、`reader_runtime.md`、`reader_spec.md`、`DATABASE.md`、`release.md`
